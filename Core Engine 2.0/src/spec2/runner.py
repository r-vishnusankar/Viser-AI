...
from spec2.executor import run, run_with_browser_use_sync
...
def main():
    ...
    if args.provider == "compare":
        results = compare(args.request, args.url)  # Pass URL to compare function
    ...
    plan = planner.plan(args.request, args.url)  # Pass URL to plan function
